...
TAGS=with_gvisor,with_quic,with_ech,with_utls,with_clash_api
...
android: lib_install
	gomobile bind -v -androidapi=21 -javapkg=com.lamp -libname=box -tags=$(TAGS) -trimpath -target=android -o $(BINDIR)/$(LIBNAME).aar github.com/sagernet/sing-box/experimental/libbox ./mobile
